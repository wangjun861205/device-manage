...
CREATE TABLE IF NOT EXISTS `device` (
    ...
    update_at timestamp not null default current_timestamp on update current_timestamp comment '更新时间',
    primary key (id),
    foreign key `fk_deviceinfo` (device_info_id) references `device_info` (id)
...
CREATE TABLE IF NOT EXISTS `subsystem` (
    ...
    subsystem_info_id int not null comment '子系统类型id',
    create_at timestamp not null default current_timestamp comment '创建时间',
    update_at timestamp not null default current_timestamp on update current_timestamp comment '更新时间',
    primary key(id),
    unique key `uni_deviceid_subsystemid` (device_id, subsystem_info_id),
    foreign key `fk_device` (device_id) references `device` (id),
    foreign key `fk_subsysteminfo` (subsystem_info_id) references `subsystem_info` (id)
...
CREATE TABLE IF NOT EXISTS `component` (
    id int not null auto_increment comment 'id',
    component_info_id int not null comment '零件信息id',
    subsystem_id int not null comment '子系统id',
    create_at timestamp not null default current_timestamp comment '创建时间',
    update_at timestamp not null default current_timestamp on update current_timestamp comment '更新时间',
    primary key (id),
    foreign key `fk_componentinfoid` (component_info_id) references `component_info` (id) on delete cascade,
...
CREATE TABLE IF NOT EXISTS `device_info__subsystem_info` (
    id int not null auto_increment comment 'id',
    device_info_id int not null comment '设备信息id',
...
CREATE TABLE IF NOT EXISTS `subsystem_info__component_info` (
    id int not null auto_increment comment 'id',
    subsystem_info_id int not null comment '子系统信息id',
